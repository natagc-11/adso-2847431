  ...
  <div class="flex-none">
    ...
    @auth
        <ul class="flex items-center gap-2">
            ...
            <li>
                <span class="badge text-white border-purple-800 bg-purple-800">{{ Auth::user()->fullname }}</span>
            </li>
            <li>
                <details class="dropdown dropdown-end">
                    ...
                    <ul class="menu dropdown-content bg-purple-800 rounded-box z-1 w-52 p-2 shadow-sm">
                        ...
                        <li>
                            <a href="{{ url('pets') }}">
                                <svg  class="size-6" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" fill="#fff">
