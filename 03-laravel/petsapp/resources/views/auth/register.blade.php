...
@section('content')
    ...
    <form method="post" action="{{ route('register') }}" class="pt-30 pb-20">
        ...
        <fieldset class="fieldset w-md bg-base-200 border border-base-300 p-4 rounded-box">
                ...
                <button class="btn mt-4 p-6 rounded-full text-white bg--800 w-full">Register</button>

                <a class="underline mt-2 text-sm text--800 hover:text--900 rounded-md focus:outline-none" href="{{ route('login') }}">
